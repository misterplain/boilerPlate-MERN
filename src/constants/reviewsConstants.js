...
export const FETCH_TOPREVIEWS_REQUEST = "FETCH_TOPREVIEWS_REQUEST";
export const FETCH_TOPREVIEWS_SUCCESS = "FETCH_TOPREVIEWS_SUCCESS";
export const FETCH_TOPREVIEWS_FAIL = "FETCH_TOPREVIEWS_FAIL";

export const FETCH_UNMODERATED_REVIEWS_REQUEST =
  "FETCH_UNMODERATED_REVIEWS_REQUEST";
export const FETCH_UNMODERATED_REVIEWS_SUCCESS =
  "FETCH_UNMODERATED_REVIEWS_SUCCESS";
export const FETCH_UNMODERATED_REVIEWS_FAIL = "FETCH_UNMODERATED_REVIEWS_FAIL";
